...
namespace Aemaddin\Zoho\Command;
...
class ZohoAuthentication extends Command
{
    ...
    public function handle()
    {
        ...
        $redirect_url = 'https://accounts.zoho.com/oauth/v2/auth?scope=ZohoCRM.modules.ALL,ZohoCRM.settings.ALL&prompt=consent&client_id=' . $client_id . '&response_type=code&access_type=offline&redirect_uri=' . $redirect_route;

        ZohoOauthSetting::updateOrCreate(
            ['client_id' => $client_id],
            [
                'client_id' => $client_id,
